...
export default function Projects() {
  return (
    <div className="mt-4" id='Projects'>
        ...
        <Project projectName='FREE TO FUN' link={'https://free-to-fun.vercel.app/'} image={FrreToFunImage} celImage={FrreToFunCelImage} 
        icons={[
        ...
        <Project projectName='Petshop' link={'https://petshop-arthurdias.vercel.app/'} image={PetshopImage} celImage={PetshopCelImage} 
        icons={[
          ...
          <Icon element={<SiShadcnui/> } extraClass={'text-[44px] text-black'} hoverColor={false}/>]}
