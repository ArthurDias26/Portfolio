...
export default function Project({projectName, image, celImage, icons, description}) {
  return (
    <div className="pl-36 mt-16 mb-32 max-tbsm:pl-0">
        <h3 className="font-bold  font-openSans text-4xl mb-4 max-tbsm:pl-24 max-mbxl:text-[32px] max-mbsm:text-[26px] max-mbsm:pl-10">{projectName}</h3>

        <div className="flex justify-around items-center w-full max-tbsm:flex-col max-tbsm:gap-16">

            <div className="w-[55%] relative max-tbxl:w-[45%] max-tbsm:w-[55%]">
            ...
            <div className="w-[30%] max-tbxl:w-[35%] max-tbsm:w-[55%] max-mbsm:w-4/5">
