export default function Icon({element, link, hoverColor='#fde59e', extraClass, activated=false, download=false}) {
  ...
  return (
    ...
    `}>
        ...
        <a href={link} target="_blank" className="flex justify-center items-end" download={`${download ? download : ""}`}>
